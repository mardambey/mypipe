...
abstract class SQSMutationAvroConsumer[InsertMutationType <: SpecificRecord, UpdateMutationType <: SpecificRecord, DeleteMutationType <: SpecificRecord, SchemaId](
  topic: String,
  sqsQueue: String,
  groupId: String,
  schemaIdSizeInBytes: Int)(insertCallback: (InsertMutationType) ⇒ Boolean,
    ...
    extends SQSConsumer(topic, sqsQueue, groupId) {
